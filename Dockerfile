...
FROM ubuntu:14.04
MAINTAINER KilleX
LABEL Description="Linux Ubuntu 14.04 image with the Swift 4.0 binaries and tools."
USER root

# Set environment variables for image
ENV SWIFT_FILE swift-4.0-DEVELOPMENT-SNAPSHOT-2017-08-04-a-ubuntu14.04
ENV SWIFT_URL https://swift.org/builds/swift-4.0-branch/ubuntu1404/swift-4.0-DEVELOPMENT-SNAPSHOT-2017-08-04-a/swift-4.0-DEVELOPMENT-SNAPSHOT-2017-08-04-a-ubuntu14.04.tar.gz
ENV WORK_DIR /
